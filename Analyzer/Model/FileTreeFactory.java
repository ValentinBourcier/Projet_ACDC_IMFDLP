...
public class FileTreeFactory implements FileVisitor<Path>, Callable {
	 ...
	 * @param root
	 *            The root object of the future FileTree
	 * @param filter
	 *            The Filter used to restrict files in the Tree
	 * @param thread
	 *            Boolean, equals true for building the FileTree using threads
	 *            (increase required resources)
	 * @param hash
	 *            Boolean equals to True if the factory should hash files
	 * @param recordInCache
	 *            Boolean equals to True if the factory should use the cache
	 * @param maxDepth
	 *            Integer equivalent to the max depth of the tree that you want to
	 *            build
	 */
	@SuppressWarnings("hiding")
	public FileTreeFactory(Path rootPath, DefaultMutableTreeNode root, Filter filter, Boolean thread, Boolean hash,
	...
	public FileVisitResult preVisitDirectory(Path dir, BasicFileAttributes attrs) throws IOException {
		if (Files.isReadable(dir))
		{
			...
			if (thread)
			{
				...
				{
					FileTreeFactory factory = new FileTreeFactory(dir, root, filter, thread, hash, recordInCache,
					        maxDepth);
