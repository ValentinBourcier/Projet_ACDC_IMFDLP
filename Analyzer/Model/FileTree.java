...
public class FileTree extends Analyzer {
	...
	/**
	 * Method returning the FileNode contained on the indicated
	 * DefaultMutableTreeNode
	 * 
	 * @param path
	 *            A string representation of the node path in the tree
	 ...
	 * 
	 * @param node
	 *            A DefaultMutableTreeNode containing a FileNode
	 * @return FileNode contained by the node in argument
	 */
	@Override
	...
	/**
	 * Method getting a node from his path on the tree Exemple: if root path is:
	 * "/home/", path could be "/session/.../". Path "/session/" is not valid, use
	 * getRoot()
	 * 
	 * @param path
	 *            The string representation of the node path searched
	 ...
	 * 
	 * @param filter
	 *            Filter used to check files
	 * @param path
	 *            String representation of the path on which you want to ckeck
	 *            duplicates
	 ...
	 *            Filter used to check files
	 * @param node
	 *            Node on which you want to ckeck duplicates
	 * @return Return list of duplicates indexed by hash in a map.
	 */
	@Override
	 ...
	 *            Filter used to check files
	 * @param thread
	 *            Boolean, equals true for building the FileTree using threads
	 *            (increase required resources)
	 * @param hash
	 *            Boolean, equals true for hashing files on tree building, false
	 *            either
	 * @param recordInCache
	 *            Boolean, equals true for saving tree files on cache.
	 * @return The DefaultMutableTreeNode root of the Tree in a thread result
	 *         object.
	 */
	@Override
	@SuppressWarnings("unchecked")
	public Future<DefaultMutableTreeNode> buildFileTree(String rootPath, Filter filter, Boolean thread, Boolean hash,
	        Boolean recordInCache, int maxDepth) {
	 ...
	 */
	@Override
	public Future<DefaultMutableTreeNode> buildFileTree(String rootPath, Boolean thread, Boolean hash,
	        Boolean recordInCache, int maxDepth) {
	...
	/**
	 * Method used to launch the semi real-time listening of the system (checking
	 * all N seconds)
	 * 
	 * @param millisRefresh
	 *            Refreshing delay in milli-seconds
	 */
	@Override
	 ...
	 * 
	 * @param node
	 *            DefaultMutableTreeNode instance to delete
	 */
	@Override
